...
for(let line of lines ) {
    if(line.startX !== line.endX && line.startY !== line.endY) {
        ...
        let startX = (line.startX < line.endX) ? line.startX : line.endX;
        let startY = (line.startX < line.endX) ? line.startY : line.endY;
        let endX = (line.startX < line.endX) ? line.endX : line.startX;
        let endY = (line.startX < line.endX) ? line.endY : line.startY;
        
        for(let i = 0; i + startX <= endX; i++)
            map[(endY > startY)?startY + i : startY - i][startX + i]++;
